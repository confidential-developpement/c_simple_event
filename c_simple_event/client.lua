...
RegisterNetEvent('eventPed')
AddEventHandler('eventPed', function()
    local hash = GetHashKey("s_m_y_ammucity_01")
    while not HasModelLoaded(hash) do
        RequestModel(hash)
        Wait(20)
    end
    ped = CreatePed("PED_TYPE_CIVMALE", "s_m_y_ammucity_01", -1467.0518, -245.9757, 49.9493 -0.98, 50.1644, true, true)
